...
<html lang="es">
    <head>
        ...
        <title>Mandato menores 18 años</title>
    ...
    <body class="mx-auto" style="width: 1350px;"><!-- margen auto para ancho específico -->
        ...
        <main class="mainBody mt-3" style="text-align:justify; text-justify: inter-word; font-size: 30px; line-height:40px;"><!-- Justificado texto a ancho página -->
            <?php
            foreach ($resultado as $valor) {
                ?>
                <p>D/Dª <span class="text-uppercase"><?php echo $valor['nombre'] . ' ' . $valor['apellido1'] . ' ' . $valor['apellido2']; ?></span> <strong>(deportista)</strong> con <span class="text-uppercase"><?php echo $valor['tipo']; ?></span>
        ...
        <footer class="fixed-bottom" style="font-size: 30px;">
            <p class="text-muted">Impreso para deportistas menores de 18 años</p>
        </footer>
    </body>
</html>
<?php
